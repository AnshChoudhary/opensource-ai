...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative overflow-hidden border-b border-gray-800" style={{ minHeight: 'calc(100vh - 140px)' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-full flex items-center justify-center py-20">
          ...
          >
            ...
            >
              ...
              <span className="text-gray-300 text-sm font-mono">open_source_alternatives</span>
            </motion.div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight font-mono">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              ...
              >
                ...
                <span className="text-gray-300 font-mono text-sm">$0/month</span>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                <span className="text-gray-300 font-mono text-sm">open_source</span>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                <span className="text-gray-300 font-mono text-sm">self_hosted</span>
              </motion.div>
            </div>
