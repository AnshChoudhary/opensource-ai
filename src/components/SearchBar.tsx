    ...
    >
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-8 pr-12 py-4 text-gray-100 frosted-glass rounded-lg focus:outline-none focus:border-accent-500 focus:ring-2 focus:ring-accent-500/20 transition-all placeholder-gray-600 font-mono"
        />
        {value && (
          <button
            onClick={() => onChange('')}
